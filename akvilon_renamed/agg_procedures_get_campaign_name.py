...
def get_campaign_name(date, utm_source, utm_medium, utm_campaign, utm_content, utm_term, ct_campaign_name):
    if get_channel(date, utm_source, utm_medium, utm_campaign, utm_content, utm_term, ct_campaign_name) == "Контекстная реклама" and re.search(r'cn\\|', utm_content):
        return re.search(r'cn\\|([^\\|]+)', utm_campaign).group(1)
    return None
