...
def get_placement(parameter):
    ...
    if get_cpa(parameter) is not None:
        return get_cpa(parameter)
    elif re.search(r'yandex|яндекс', parameter) and not re.search(r'realty|недвижимость', parameter):
        ...
        return 'Домклик'
    elif re.search(r'novostroy-m_базы', parameter):
        return 'Новострой-М'
