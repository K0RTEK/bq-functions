...
def get_channel(calltracking, utm_source, utm_medium, utm_campaign, utm_content, utm_term, traffic_source):
    ...
    elif (utm_source == 'yandex' and utm_medium in ('cpc', 'cpm')) or re.search(r'яндекс(.|..)директ', calltracking):
        return 'Яндекс Директ'
    elif (re.search(r'google', utm_source) and
          re.search(r'cpc', utm_medium) and
          (re.search(r'mg_', utm_campaign) or
           re.search(r'mg_', utm_content) or
           re.search(r'mg_', utm_term)) or
          (re.search(r'mg|sm', calltracking) and
           re.search(r'google|гугл', calltracking))):
        return 'Google Ads'
    ...
    elif (re.search(r'vk_ads|vk_reklama', utm_source) or
          re.search(r'_vk$|^vk$|^vk_', utm_source) or
          re.search(r'mytarget|_mt$', utm_source) or
          re.search(r'facebook|fb_ig|inst|_fb$', utm_source) or
          re.search(r'tiktok', utm_source) or
          re.search(r'telegram', utm_source)) and utm_medium in ('cpc', 'cpm'):
